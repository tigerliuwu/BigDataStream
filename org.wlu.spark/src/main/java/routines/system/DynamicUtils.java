            ...
            if (value == null) {
                if (DBMSConstants.SYBASE.getDBmsId().equalsIgnoreCase(database)) {
                    ...
                    pstmt.setNull(fixedColumnCount + i + 1, java.sql.Types.BINARY);
                        ...
                        && (("id_Date".equals(column.getColumnMetadata(i).getType())
                                || "id_Time".equals(column.getColumnMetadata(i).getType()) || "id_Timestamp".equals(column
                                .getColumnMetadata(i).getType())))) {
    ...
    public static StringBuffer debugDynamicSql(StringBuffer query, Dynamic column, int fixedColumnCount, String[] sqlsplit)
        ...
        for (int i = 0; i < column.getColumnCount(); i++) {
            ...
            if (value == null) {
                ...
                String formatValue = FormatterUtils.format_Date((java.util.Date) value, column.getColumnMetadata(i).getFormat());
